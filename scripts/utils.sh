...
function exportPaths () {
    ...
    export OPENMRS_MODULES_SSO_PATH=$DISTRO_PATH/binaries/openmrs/modules_sso
    export OPENMRS_CONFIG_SSO_PATH=$DISTRO_PATH/configs/openmrs/initializer_config_sso
    export OPENMRS_PROPERTIES_SSO_PATH=$DISTRO_PATH/configs/openmrs/properties_sso
    ...
    export OPENMRS_FRONTEND_CONFIG_SSO_PATH=$DISTRO_PATH/configs/openmrs/frontend_config_sso/
    ...
    echo "→ OPENMRS_MODULES_SSO_PATH=$OPENMRS_MODULES_SSO_PATH"
    echo "→ OPENMRS_CONFIG_SSO_PATH=$OPENMRS_CONFIG_SSO_PATH"
    echo "→ OPENMRS_PROPERTIES_SSO_PATH=$OPENMRS_PROPERTIES_SSO_PATH"
    ...
    echo "→ OPENMRS_FRONTEND_CONFIG_SSO_PATH=$OPENMRS_FRONTEND_CONFIG_SSO_PATH"
